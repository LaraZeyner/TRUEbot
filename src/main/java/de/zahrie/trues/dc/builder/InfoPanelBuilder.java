package de.zahrie.trues.dc.builder;

import java.util.List;

import de.zahrie.trues.dc.builder.embed.EmbedQueryBuilder;
import de.zahrie.trues.dc.builder.string.StringCreator;
import de.zahrie.trues.dc.util.cmd.annotations.DBQuery;
import de.zahrie.trues.dc.builder.embed.EmbedCreator;
import de.zahrie.trues.dc.builder.string.StringQueryBuilder;
