...
public abstract class MatchParticipant extends OriannaObject<de.zahrie.trues.api.riot.xayah.types.data.match.Participant> {
    @Serial
    private static final long serialVersionUID = 5673949825555239078L;

    public MatchParticipant(final de.zahrie.trues.api.riot.xayah.types.data.match.Participant coreData) {
        super(coreData);
    }
