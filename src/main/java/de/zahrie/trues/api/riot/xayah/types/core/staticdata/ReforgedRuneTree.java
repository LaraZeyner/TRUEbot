...
public class ReforgedRuneTree extends OriannaObject<de.zahrie.trues.api.riot.xayah.types.data.staticdata.ReforgedRuneTree> {
    @Serial
    private static final long serialVersionUID = 3917722561308840927L;

    private int counter = 0;

    private final Supplier<ReforgedRunePath> domination = Suppliers.memoize(new Supplier<>() {
      @Override
    ...
    private final Supplier<ReforgedRunePath> inspiration = Suppliers.memoize(new Supplier<>() {
      @Override
      public ReforgedRunePath get() {
    ...
    private final Supplier<ReforgedRunePath> precision = Suppliers.memoize(new Supplier<>() {
      @Override
      public ReforgedRunePath get() {
    ...
    private final Supplier<ReforgedRunePath> resolve = Suppliers.memoize(new Supplier<>() {
      @Override
      public ReforgedRunePath get() {
    ...
    private final Supplier<ReforgedRunePath> sorcery = Suppliers.memoize(new Supplier<>() {
      @Override
      public ReforgedRunePath get() {
    ...
    public ReforgedRuneTree(final de.zahrie.trues.api.riot.xayah.types.data.staticdata.ReforgedRuneTree coreData, final List<ReforgedRune> runes) {
        super(coreData);
