...
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Champion;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ChampionSpell;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ChampionStats;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Champions;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Image;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Item;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ItemGroup;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ItemSet;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ItemStats;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ItemTree;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Items;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.LanguageStrings;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Languages;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Maps;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Masteries;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Mastery;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.MasteryTree;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.MasteryTreeItem;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.MasteryTreeTier;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Passive;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Patch;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Patches;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ProfileIcon;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ProfileIcons;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Realm;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.RecommendedItems;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ReforgedRune;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ReforgedRunePath;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ReforgedRuneSlot;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ReforgedRuneTree;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.ReforgedRunes;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Rune;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.RuneStats;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Runes;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Skin;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.SpellVariables;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Sprite;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.SummonerSpell;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.SummonerSpells;
import de.zahrie.trues.api.riot.xayah.types.data.staticdata.Versions;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Block;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.BlockItem;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ChampionList;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Gold;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Group;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Info;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.InventoryDataStats;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ItemList;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.LevelTip;
...
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTreeList;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MetaData;
...
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Recommended;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.RuneList;
import de.zahrie.trues.api.riot.xayah.types.dto.staticdata.SpellVars;
...
public class StaticDataTransformer extends AbstractDataTransformer {
    ...
    @Transform(from = Champion.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Champion.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Champion transform(final Champion item, final PipelineContext context) {
        final Object previous = context.put("key", item.getKey());
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Champion champion = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Champion();
        ...
        if(item.getSkins() != null) {
            final List<de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Skin> skins = new ArrayList<>(item.getSkins().size());
        ...
        if(item.getSpells() != null) {
            final List<de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ChampionSpell> spells = new ArrayList<>(item.getSpells().size());
    ...
    public Champions transform(final ChampionList item, final PipelineContext context) {
        ...
        for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Champion champion : item.getData().values()) {
    ...
    public ChampionList transform(final Champions item, final PipelineContext context) {
        ...
        final Map<String, de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Champion> data = new HashMap<>();
    ...
    @Transform(from = ChampionSpell.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ChampionSpell.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ChampionSpell transform(final ChampionSpell item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ChampionSpell spell = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ChampionSpell();
        if(item.getAlternativeImages() != null) {
            final List<de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Image> alternativeImages = new ArrayList<>(item.getAlternativeImages().size());
    ...
    @Transform(from = ChampionStats.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Stats.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Stats transform(final ChampionStats item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Stats stats = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Stats();
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.data.staticdata.Map.class, to = MapDetails.class)
    public MapDetails transform(final de.zahrie.trues.api.riot.xayah.types.data.staticdata.Map item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Champion.class, to = Champion.class)
    public Champion transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Champion item, final PipelineContext context) {
        ...
        if(item.getSkins() != null) {
            ...
            for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Skin skin : item.getSkins()) {
                skins.add(transform(skin, context));
            }
            champion.setSkins(skins);
        }
        if(item.getSpells() != null) {
            ...
            for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ChampionSpell spell : item.getSpells()) {
                spells.add(transform(spell, context));
            }
            champion.setSpells(spells);
        }
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ChampionSpell.class, to = ChampionSpell.class)
    public ChampionSpell transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ChampionSpell item, final PipelineContext context) {
        ...
        if(item.getAltImages() != null) {
            ...
            for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Image image : item.getAltImages()) {
                alternativeImages.add(transform(image, context));
            }
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Image.class, to = Image.class)
    public Image transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Image item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Item.class, to = Item.class)
    public Item transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Item item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ItemTree.class, to = ItemTree.class)
    public ItemTree transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ItemTree item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Languages.class, to = Languages.class)
    public Languages transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Languages item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.LanguageStrings.class, to = LanguageStrings.class)
    public LanguageStrings transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.LanguageStrings item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Mastery.class, to = Mastery.class)
    public Mastery transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Mastery item, final PipelineContext context) {
        final Object previous = context.put("version", item.getVersion());
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTree.class, to = MasteryTree.class)
    public MasteryTree transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTree item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTreeItem.class, to = MasteryTreeItem.class)
    public MasteryTreeItem transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTreeItem item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Passive.class, to = Passive.class)
    public Passive transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Passive item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Patch.class, to = Patch.class)
    public Patch transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Patch item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Patches.class, to = Patches.class)
    public Patches transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Patches item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRune.class, to = ReforgedRune.class)
    public ReforgedRune transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRune item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRunePath.class, to = ReforgedRunePath.class)
    public ReforgedRunePath transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRunePath item, final PipelineContext context) {
        final ReforgedRunePath path = new ReforgedRunePath(item.getSlots().size());
        for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneSlot slot : item.getSlots()) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneSlot.class, to = ReforgedRuneSlot.class)
    public ReforgedRuneSlot transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneSlot item, final PipelineContext context) {
        final ReforgedRuneSlot slot = new ReforgedRuneSlot(item.getRunes().size());
        for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRune rune : item.getRunes()) {
            slot.add(rune.getId());
        }
        return slot;
    }

    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree.class, to = ReforgedRunes.class)
    public ReforgedRunes transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree item, final PipelineContext context) {
        int count = 0;
        for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRunePath path : item) {
            for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneSlot slot : path.getSlots()) {
        ...
        for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRunePath path : item) {
            for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneSlot slot : path.getSlots()) {
                for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRune rune : slot.getRunes()) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Rune.class, to = Rune.class)
    public Rune transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Rune item, final PipelineContext context) {
        final Object previous = context.put("version", item.getVersion());
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.RuneStats.class, to = RuneStats.class)
    public RuneStats transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.RuneStats item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Skin.class, to = Skin.class)
    public Skin transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Skin item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Stats.class, to = ChampionStats.class)
    public ChampionStats transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Stats item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.SummonerSpell.class, to = SummonerSpell.class)
    public SummonerSpell transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.SummonerSpell item, final PipelineContext context) {
        final Object previous = context.put("version", item.getVersion());
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Versions.class, to = Versions.class)
    public Versions transform(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Versions item, final PipelineContext context) {
    ...
    @Transform(from = Image.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Image.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Image transform(final Image item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Image image = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Image();
        image.setFull(item.getFull());
        image.setGroup(item.getGroup());
    ...
    @Transform(from = Item.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Item.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Item transform(final Item item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Item converted = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Item();
        ...
        for(final de.zahrie.trues.api.riot.xayah.types.common.Map map : de.zahrie.trues.api.riot.xayah.types.common.Map.values()) {
    ...
    public Items transform(final ItemList item, final PipelineContext context) {
        ...
        for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Item it : item.getData().values()) {
        ...
        if(item.getTree() != null) {
            ...
            for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ItemTree t : item.getTree()) {
    ...
    public ItemList transform(final Items item, final PipelineContext context) {
        ...
        final Map<String, de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Item> data = new HashMap<>();
        ...
        items.setPlatform(item.getPlatform());
        if(item.getTree() != null) {
            final List<de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ItemTree> tree = new ArrayList<>(item.getTree().size());
    ...
    @Transform(from = ItemTree.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ItemTree.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ItemTree transform(final ItemTree item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ItemTree tree = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ItemTree();
        tree.setHeader(item.getHeader());
        if(item.getTags() != null) {
            tree.setTags(new ArrayList<>(item.getTags()));
        }
    ...
    @Transform(from = Languages.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Languages.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Languages transform(final Languages item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Languages languages = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Languages();
        languages.addAll(item);
        languages.setPlatform(item.getPlatform());
        return languages;
    }

    @Transform(from = LanguageStrings.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.LanguageStrings.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.LanguageStrings transform(final LanguageStrings item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.LanguageStrings strings = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.LanguageStrings();
    ...
    @Transform(from = MapDetails.class, to = de.zahrie.trues.api.riot.xayah.types.data.staticdata.Map.class)
    public de.zahrie.trues.api.riot.xayah.types.data.staticdata.Map transform(final MapDetails item, final PipelineContext context) {
        final Object previous = context.put("version", item.getVersion());
        final de.zahrie.trues.api.riot.xayah.types.data.staticdata.Map map = new de.zahrie.trues.api.riot.xayah.types.data.staticdata.Map();
    ...
    public MapData transform(final Maps item, final PipelineContext context) {
        ...
        for(final de.zahrie.trues.api.riot.xayah.types.data.staticdata.Map map : item) {
    ...
    public MasteryList transform(final Masteries item, final PipelineContext context) {
        ...
        final Map<String, de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Mastery> data = new HashMap<>(item.size());
    ...
    @Transform(from = Mastery.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Mastery.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Mastery transform(final Mastery item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Mastery mastery = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Mastery();
    ...
    public Masteries transform(final MasteryList item, final PipelineContext context) {
        ...
        for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Mastery mastery : item.getData().values()) {
    ...
    @Transform(from = MasteryTree.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTree.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTree transform(final MasteryTree item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTree tree = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTree();
        if(item.getCunning() != null) {
    ...
    @Transform(from = MasteryTreeItem.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTreeItem.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTreeItem transform(final MasteryTreeItem item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTreeItem converted =
            new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTreeItem();
    ...
    public MasteryTreeTier transform(final MasteryTreeList item, final PipelineContext context) {
        ...
        if(item.getMasteryTreeItems() != null) {
            for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTreeItem it : item.getMasteryTreeItems()) {
    ...
    public MasteryTreeList transform(final MasteryTreeTier item, final PipelineContext context) {
        ...
        final List<de.zahrie.trues.api.riot.xayah.types.dto.staticdata.MasteryTreeItem> items = new ArrayList<>();
    ...
    @Transform(from = Passive.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Passive.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Passive transform(final Passive item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Passive passive = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Passive();
        passive.setDescription(item.getDescription());
        if(item.getImage() != null) {
            passive.setImage(transform(item.getImage(), context));
        }
    ...
    @Transform(from = Patch.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Patch.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Patch transform(final Patch item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Patch patch = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Patch();
    ...
    @Transform(from = ReforgedRune.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRune.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRune transform(final ReforgedRune item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRune rune = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRune();
    ...
    @Transform(from = ReforgedRunePath.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRunePath.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRunePath transform(final ReforgedRunePath item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRunePath path = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRunePath();
        final List<de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneSlot> list = new ArrayList<>(item.size());
    ...
    @Transform(from = ReforgedRunes.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree transform(final ReforgedRunes item, final PipelineContext context) {
        ...
        final Object previousPlatform = context.put("platform", item.getPlatform());
        final Object previousVersion = context.put("version", item.getVersion());
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree tree = transform(item, context);
    ...
    @Transform(from = ReforgedRuneSlot.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneSlot.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneSlot transform(final ReforgedRuneSlot item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneSlot slot = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneSlot();
        final Map<Integer, ReforgedRune> runes = (Map<Integer, ReforgedRune>)context.get("runes");
        final List<de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRune> list = new ArrayList<>(item.size());
    ...
    @Transform(from = ReforgedRuneTree.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree transform(final ReforgedRuneTree item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree tree = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree(5);
    ...
    @Transform(from = Rune.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Rune.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Rune transform(final Rune item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Rune rune = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Rune();
        rune.setDescription(item.getDescription());
        rune.setId(item.getId());
        if(item.getImage() != null) {
            rune.setImage(transform(item.getImage(), context));
    ...
    public Runes transform(final RuneList item, final PipelineContext context) {
        ...
        for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Rune rune : item.getData().values()) {
            runes.add(transform(rune, context));
        }
    ...
    public RuneList transform(final Runes item, final PipelineContext context) {
        ...
        final Map<String, de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Rune> data = new HashMap<>();
    ...
    @Transform(from = RuneStats.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.RuneStats.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.RuneStats transform(final RuneStats item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.RuneStats stats = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.RuneStats();
        stats.setFlatMagicDamageMod(item.getAbilityPower());
    ...
    @Transform(from = Skin.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Skin.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Skin transform(final Skin item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Skin skin = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Skin();
        skin.setId(item.getId());
        skin.setName(item.getName());
    ...
    @Transform(from = SummonerSpell.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.SummonerSpell.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.SummonerSpell transform(final SummonerSpell item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.SummonerSpell spell = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.SummonerSpell();
        if(item.getCooldowns() != null) {
            spell.setCooldown(new ArrayList<>(item.getCooldowns()));
            spell.setCooldownBurn(getBurn(item.getCooldowns()));
        }
    ...
    public SummonerSpells transform(final SummonerSpellList item, final PipelineContext context) {
        ...
        for(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.SummonerSpell spell : item.getData().values()) {
            spells.add(transform(spell, context));
        }
    ...
    public SummonerSpellList transform(final SummonerSpells item, final PipelineContext context) {
        ...
        final Map<String, de.zahrie.trues.api.riot.xayah.types.dto.staticdata.SummonerSpell> data = new HashMap<>();
    ...
    @Transform(from = Versions.class, to = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Versions.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Versions transform(final Versions item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Versions versions = new de.zahrie.trues.api.riot.xayah.types.dto.staticdata.Versions(item.size());
        versions.addAll(item);
        versions.setPlatform(item.getPlatform());
        return versions;
    }

    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree.class, to = ReforgedRuneTree.class)
    public ReforgedRuneTree transformTree(final de.zahrie.trues.api.riot.xayah.types.dto.staticdata.ReforgedRuneTree item, final PipelineContext context) {
