...
import de.zahrie.trues.api.riot.xayah.datapipeline.kernel.exceptions.GatewayTimeoutException;
...
public class KernelService extends AbstractDataSource {
    ...
    public interface FailedRequestStrategy {
        ...
        <T extends DataObject> T onFailedRequest(KernelService service, RequestContext<T> context, Response response, OriannaException e);
    }
