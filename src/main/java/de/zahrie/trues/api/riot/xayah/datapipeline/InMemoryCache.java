...
import de.zahrie.trues.api.riot.xayah.types.UniqueKeys;
...
import de.zahrie.trues.api.riot.xayah.types.core.GhostObject.ListProxy;
import de.zahrie.trues.api.riot.xayah.types.core.GhostObject.LoadHook;
...
public class InMemoryCache extends AbstractDataStore {
  public static class Configuration {
    ...
    /**
     * @param expirationPeriods the expirationPeriods to set
     */
  ...
  private class Policy implements ExpiryPolicy<Integer, Object> {
    @Override
    public long calculateExpiryTime(@NotNull final Integer key, final Object value, final long loadTime, final CacheEntry<Integer, Object> oldEntry) {
      final Long period = expirationPeriods.get(value != null ? value.getClass() : null);
      return period != null && period > 0L ? loadTime + period : ExpiryTimeValues.ETERNAL;
    }
  }
  ...
  public InMemoryCache(final Configuration config) {
    ...
    cache = new Cache2kBuilder<Integer, Object>() {
    }.disableStatistics(true).expiryPolicy(new Policy()).keepDataAfterExpired(false).permitNullValues(false)
  ...
  public CloseableIterator<Item> getManyItem(final java.util.Map<String, Object> query, final PipelineContext context) {
    final List<Integer> keys = Lists.newArrayList(Objects.requireNonNull(UniqueKeys.forManyItemQuery(query)));
    for (final Integer key : keys) {
      if (!cache.containsKey(key)) {
        return null;
      }
  ...
  public CloseableIterator<Map> getManyMap(final java.util.Map<String, Object> query, final PipelineContext context) {
    final List<Integer> keys = Lists.newArrayList(Objects.requireNonNull(UniqueKeys.forManyMapQuery(query)));
    for (final Integer key : keys) {
      if (!cache.containsKey(key)) {
        return null;
      }
  ...
  public CloseableIterator<Mastery> getManyMastery(final java.util.Map<String, Object> query, final PipelineContext context) {
    final List<Integer> keys = Lists.newArrayList(Objects.requireNonNull(UniqueKeys.forManyMasteryQuery(query)));
    for (final Integer key : keys) {
      if (!cache.containsKey(key)) {
        return null;
      }
  ...
  public CloseableIterator<ReforgedRune> getManyReforgedRune(final java.util.Map<String, Object> query, final PipelineContext context) {
    final List<Integer> keys = Lists.newArrayList(Objects.requireNonNull(UniqueKeys.forManyReforgedRuneQuery(query)));
    for (final Integer key : keys) {
      if (!cache.containsKey(key)) {
        return null;
      }
  ...
  public CloseableIterator<Rune> getManyRune(final java.util.Map<String, Object> query, final PipelineContext context) {
    final List<Integer> keys = Lists.newArrayList(Objects.requireNonNull(UniqueKeys.forManyRuneQuery(query)));
    for (final Integer key : keys) {
      if (!cache.containsKey(key)) {
        return null;
      }
  ...
  public CloseableIterator<SummonerSpell> getManySummonerSpell(final java.util.Map<String, Object> query, final PipelineContext context) {
    final List<Integer> keys = Lists.newArrayList(Objects.requireNonNull(UniqueKeys.forManySummonerSpellQuery(query)));
    for (final Integer key : keys) {
      if (!cache.containsKey(key)) {
        return null;
      }
