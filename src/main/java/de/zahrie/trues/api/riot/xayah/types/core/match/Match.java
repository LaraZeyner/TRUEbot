...
public class Match extends GhostObject<de.zahrie.trues.api.riot.xayah.types.data.match.Match> {
  ...
  public final class MatchParticipant extends de.zahrie.trues.api.riot.xayah.types.core.match.MatchParticipant {
    @Serial
    private static final long serialVersionUID = -4802669460954679635L;

    private final java.util.function.Supplier<Champion> champion = Suppliers.memoize(() -> {
      if (coreData.getChampionId() == 0) {
        return null;
      }
      RiotChampion.Builder builder = RiotChampion.withId(coreData.getChampionId()).withPlatform(Platform.withTag(coreData.getCurrentPlatform()));
      ...
      return builder.get().getChampion();
    })::get;

    private final java.util.function.Supplier<SearchableList<Item>> items = Suppliers.memoize(() -> {
    ...
    private final java.util.function.Supplier<Summoner> preTransferSummoner = Suppliers.memoize(() -> {
      load(MATCH_LOAD_GROUP);
    ...
    private final java.util.function.Supplier<ProfileIcon> profileIcon = Suppliers.memoize(() -> {
      load(MATCH_LOAD_GROUP);
    ...
    private final java.util.function.Supplier<SearchableList<RuneStats>> runeStats = Suppliers.memoize(() -> {
      load(MATCH_LOAD_GROUP);
    ...
    private final java.util.function.Supplier<ParticipantStats> stats = Suppliers.memoize(() -> {
      load(MATCH_LOAD_GROUP);
    ...
    private final java.util.function.Supplier<Summoner> summoner = Suppliers.memoize(() -> {
    ...
    private final java.util.function.Supplier<SummonerSpell> summonerSpellD = Suppliers.memoize(() -> {
      load(MATCH_LOAD_GROUP);
    ...
    private final java.util.function.Supplier<SummonerSpell> summonerSpellF = Suppliers.memoize(() -> {
      load(MATCH_LOAD_GROUP);
    ...
    private final java.util.function.Supplier<de.zahrie.trues.api.riot.xayah.types.core.match.Team> team =
        Suppliers.memoize(() -> {
          load(MATCH_LOAD_GROUP);
    ...
    private final java.util.function.Supplier<ParticipantTimeline> timeline = Suppliers.memoize(() -> {
      load(MATCH_LOAD_GROUP);
    ...
    private MatchParticipant(final de.zahrie.trues.api.riot.xayah.types.data.match.Participant coreData) {
      super(coreData);
    }
  ...
  public final class Team extends de.zahrie.trues.api.riot.xayah.types.core.match.Team {
    @Serial
    private static final long serialVersionUID = 4087259520532039291L;

    private final java.util.function.Supplier<SearchableList<Champion>> bans = Suppliers.memoize(() -> {
      ...
      return SearchableLists.unmodifiableFrom(
          Champions.withIds(coreData.getBans()).withPlatform(Platform.withTag(coreData.getPlatform())).withVersion(version).get()
              .stream().map(RiotChampion::getChampion).toList());
    })::get;

    private final java.util.function.Supplier<SearchableList<de.zahrie.trues.api.riot.xayah.types.core.match.MatchParticipant>> participants =
        Suppliers.memoize(() -> {
          final List<de.zahrie.trues.api.riot.xayah.types.core.match.MatchParticipant> matchParticipants =
              new ArrayList<>(Match.this.getParticipants().size() / 2);
          for (final de.zahrie.trues.api.riot.xayah.types.core.match.MatchParticipant matchParticipant : Match.this.getParticipants()) {
            if (matchParticipant.getCoreData().getTeam() == coreData.getTeamId()) {
              matchParticipants.add(matchParticipant);
            }
          }
          return SearchableLists.unmodifiableFrom(matchParticipants);
        })::get;

    private final java.util.function.Supplier<SearchableList<Champion>> pickTurns = Suppliers.memoize(() -> {
      final List<Champion> champions = new ArrayList<>(coreData.getPickTurns().size());
      SearchableList<de.zahrie.trues.api.riot.xayah.types.core.match.MatchParticipant> get = participants.get();
      for (int i = 0; i < get.size(); i++) {
        final Integer integer = coreData.getPickTurns().get(i);
        champions.set(integer, participants.get().get(i).getChampion());
      }
      return SearchableLists.unmodifiableFrom(champions);
    })::get;
    ...
    public SearchableList<de.zahrie.trues.api.riot.xayah.types.core.match.MatchParticipant> getParticipants() {
    ...
    @Override
    public SearchableList<Champion> getPickTurns() {
      return pickTurns.get();
    }
  ...
  private final java.util.function.Supplier<de.zahrie.trues.api.riot.xayah.types.core.match.Team> blueTeam =
      Suppliers.memoize(() -> {
        load(MATCH_LOAD_GROUP);
  ...
  private final Supplier<SearchableList<de.zahrie.trues.api.riot.xayah.types.core.match.MatchParticipant>> participants =
      Suppliers.memoize(new Supplier<>() {
        @Override
        public SearchableList<de.zahrie.trues.api.riot.xayah.types.core.match.MatchParticipant> get() {
          if (!fromReference) {
            load(MATCH_LOAD_GROUP);
            return coreData.getParticipants() == null ? null : SearchableLists.unmodifiableFrom(coreData.getParticipants().stream().map(MatchParticipant::new).collect(Collectors.toCollection(() -> new ArrayList<>(coreData.getParticipants().size()))));
          } else {
            if (coreData.getParticipants() == null) {
              return null;
            }
            final CloseableIterator<de.zahrie.trues.api.riot.xayah.types.core.match.MatchParticipant> iterator =
                new CloseableIterator<>() {
                  ...
                  @Override
                  public MatchParticipant next() {
                    return !hasNext() ? null : new MatchParticipant(iterator.next());
                  }
  ...
  private final java.util.function.Supplier<de.zahrie.trues.api.riot.xayah.types.core.match.Team> redTeam =
      Suppliers.memoize(() -> {
        load(MATCH_LOAD_GROUP);
  ...
  private final java.util.function.Supplier<Timeline> timeline = Suppliers.memoize(() -> {
  ...
  public Time getCreationTime() {
    ...
    return Time.of(new Date(coreData.getCreationTime().getMillis()));
  }
  ...
  public String getMatchId() {
    return getPlatform().getTag() + "_" + coreData.getId();
  }
  ...
  @Searchable({Summoner.class, RiotChampion.class, Item.class, String.class, long.class, int.class})
  public SearchableList<de.zahrie.trues.api.riot.xayah.types.core.match.MatchParticipant> getParticipants() {
    return participants.get();
  }
  ...
  public de.zahrie.trues.api.riot.matchhistory.game.GameType getGameQueue() {
    if (coreData.getQueue() == 0) {
      return getTournamentCode().isEmpty() ? de.zahrie.trues.api.riot.matchhistory.game.GameType.CUSTOM : de.zahrie.trues.api.riot.matchhistory.game.GameType.TOURNAMENT;
    } else {
      return de.zahrie.trues.api.riot.matchhistory.game.GameType.fromId(coreData.getQueue());
    }
  }
