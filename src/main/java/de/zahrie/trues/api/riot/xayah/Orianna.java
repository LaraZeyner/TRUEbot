package de.zahrie.trues.api.riot.xayah;
...
import de.zahrie.trues.api.riot.xayah.datapipeline.DataDragon;
import de.zahrie.trues.api.riot.xayah.datapipeline.GhostLoader;
import de.zahrie.trues.api.riot.xayah.datapipeline.ImageDownloader;
import de.zahrie.trues.api.riot.xayah.datapipeline.InMemoryCache;
import de.zahrie.trues.api.riot.xayah.datapipeline.MerakiAnalyticsCDN;
import de.zahrie.trues.api.riot.xayah.datapipeline.PipelineConfiguration;
import de.zahrie.trues.api.riot.xayah.datapipeline.PipelineConfiguration.PipelineElementConfiguration;
import de.zahrie.trues.api.riot.xayah.datapipeline.PipelineConfiguration.TransformerConfiguration;
import de.zahrie.trues.api.riot.xayah.datapipeline.common.expiration.ExpirationPeriod;
import de.zahrie.trues.api.riot.xayah.datapipeline.riotapi.RiotAPI;
import de.zahrie.trues.api.riot.xayah.datapipeline.transformers.dtodata.ChampionMasteryTransformer;
import de.zahrie.trues.api.riot.xayah.datapipeline.transformers.dtodata.ChampionTransformer;
import de.zahrie.trues.api.riot.xayah.datapipeline.transformers.dtodata.LeagueTransformer;
import de.zahrie.trues.api.riot.xayah.datapipeline.transformers.dtodata.MatchTransformer;
import de.zahrie.trues.api.riot.xayah.datapipeline.transformers.dtodata.SpectatorTransformer;
import de.zahrie.trues.api.riot.xayah.datapipeline.transformers.dtodata.StaticDataTransformer;
import de.zahrie.trues.api.riot.xayah.datapipeline.transformers.dtodata.StatusTransformer;
import de.zahrie.trues.api.riot.xayah.datapipeline.transformers.dtodata.SummonerTransformer;
import de.zahrie.trues.api.riot.xayah.datapipeline.transformers.dtodata.ThirdPartyCodeTransformer;
...
import de.zahrie.trues.api.riot.xayah.types.core.champion.ChampionRotations;
...
import de.zahrie.trues.api.riot.xayah.types.core.championmastery.ChampionMasteryScores;
...
import de.zahrie.trues.api.riot.xayah.types.core.league.Leagues;
import de.zahrie.trues.api.riot.xayah.types.core.match.Match;
import de.zahrie.trues.api.riot.xayah.types.core.match.MatchHistories;
import de.zahrie.trues.api.riot.xayah.types.core.match.MatchHistory;
import de.zahrie.trues.api.riot.xayah.types.core.match.Matches;
import de.zahrie.trues.api.riot.xayah.types.core.match.Timeline;
import de.zahrie.trues.api.riot.xayah.types.core.match.Timelines;
...
import de.zahrie.trues.api.riot.xayah.types.core.staticdata.Realms;
...
import de.zahrie.trues.api.riot.xayah.types.core.status.ShardStatuses;
import de.zahrie.trues.api.riot.xayah.types.core.summoner.Summoner;
import de.zahrie.trues.api.riot.xayah.types.core.summoner.Summoners;
import de.zahrie.trues.api.riot.xayah.types.core.thirdpartycode.VerificationString;
import de.zahrie.trues.api.riot.xayah.types.core.thirdpartycode.VerificationStrings;
...
public abstract class Orianna {
  public static class Configuration {
    ...
    /**
     * @param currentVersionExpiration the currentVersionExpiration to set
     */
  ...
  public static final class Settings {
    ...
    /**
     * @param platform the platform to get the current version for
    ...
    private Supplier<DataPipeline> newPipelineSupplier() {
      return Suppliers.memoize(() -> PipelineConfiguration.toPipeline(configuration.getPipeline()))::get;
    }

    private Supplier<String> newVersionSupplier(final Platform platform) {
      Supplier<String> supplier = () -> Versions.withPlatform(platform).get().getBestMatch(platform.getRealm().getVersion());

      if (configuration.getCurrentVersionExpiration().getPeriod() < 0) {
        supplier = Suppliers.memoize(supplier::get)::get;
      } else if (configuration.getCurrentVersionExpiration().getPeriod() > 0) {
        supplier = Suppliers.memoizeWithExpiration(supplier::get, configuration.getCurrentVersionExpiration().getPeriod(),
            configuration.getCurrentVersionExpiration().getUnit())::get;
      }
      return supplier;
    }
  ...
  private static Settings defaultSettings() {
    ...
    if (configPath != null && !configPath.isEmpty()) {
      try {
        return new Settings(getConfiguration(Files.asCharSource(new File(configPath), StandardCharsets.UTF_8)));
    ...
    try {
      return new Settings(getConfiguration(
          Resources.asCharSource(Resources.getResource("com/merakianalytics/orianna/default-orianna-config.json"), StandardCharsets.UTF_8)));
  ...
  public static void loadConfiguration(final File configJSON) {
    loadConfiguration(Files.asCharSource(configJSON, StandardCharsets.UTF_8));
  }

  public static void loadConfiguration(final String configJSONResourcePath) {
    loadConfiguration(Resources.asCharSource(Resources.getResource(configJSONResourcePath), StandardCharsets.UTF_8));
  }
   ...
   *
   * @param defaultPlatform the defaultPlatform
   */
   ...
   *
   * @param defaultRegion the defaultRegion
   */
  ...
  /**
   * Sets the Riot API key if {@link RiotAPI} is being used in the pipeline.
