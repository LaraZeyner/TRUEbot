...
import de.zahrie.trues.api.riot.xayah.types.data.spectator.FeaturedMatch;
import de.zahrie.trues.api.riot.xayah.types.data.spectator.FeaturedMatches;
import de.zahrie.trues.api.riot.xayah.types.data.spectator.GameCustomizationObject;
import de.zahrie.trues.api.riot.xayah.types.data.spectator.Participant;
import de.zahrie.trues.api.riot.xayah.types.data.spectator.Player;
import de.zahrie.trues.api.riot.xayah.types.data.spectator.Runes;
import de.zahrie.trues.api.riot.xayah.types.data.spectator.Team;
import de.zahrie.trues.api.riot.xayah.types.dto.spectator.BannedChampion;
import de.zahrie.trues.api.riot.xayah.types.dto.spectator.CurrentGameInfo;
import de.zahrie.trues.api.riot.xayah.types.dto.spectator.CurrentGameParticipant;
import de.zahrie.trues.api.riot.xayah.types.dto.spectator.FeaturedGameInfo;
import de.zahrie.trues.api.riot.xayah.types.dto.spectator.Observer;
import de.zahrie.trues.api.riot.xayah.types.dto.spectator.Perks;

public class SpectatorTransformer extends AbstractDataTransformer {
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.spectator.FeaturedGames.class, to = FeaturedMatches.class)
    public FeaturedMatches transform(final de.zahrie.trues.api.riot.xayah.types.dto.spectator.FeaturedGames item, final PipelineContext context) {
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.spectator.GameCustomizationObject.class, to = GameCustomizationObject.class)
    public GameCustomizationObject transform(final de.zahrie.trues.api.riot.xayah.types.dto.spectator.GameCustomizationObject item,
    ...
    @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.spectator.Participant.class, to = Participant.class)
    public Participant transform(final de.zahrie.trues.api.riot.xayah.types.dto.spectator.Participant item, final PipelineContext context) {
    ...
    public Player transform(final CurrentGameParticipant item, final PipelineContext context) {
        ...
        for(final de.zahrie.trues.api.riot.xayah.types.dto.spectator.GameCustomizationObject object : item.getGameCustomizationObjects()) {
    ...
    public FeaturedMatch transform(final FeaturedGameInfo item, final PipelineContext context) {
        ...
        for(final de.zahrie.trues.api.riot.xayah.types.dto.spectator.Participant player : item.getParticipants()) {
            players.add(transform(player, context));
        }
        game.setPlayers(players);
        game.setQueue((int)item.getGameQueueConfigId());
    ...
    public FeaturedGameInfo transform(final FeaturedMatch item, final PipelineContext context) {
        ...
        observer.setEncryptionKey(item.getObserverEncryptionKey());
        game.setObservers(observer);
        final List<de.zahrie.trues.api.riot.xayah.types.dto.spectator.Participant> participants = new ArrayList<>(item.getPlayers().size());
    ...
    @Transform(from = FeaturedMatches.class, to = de.zahrie.trues.api.riot.xayah.types.dto.spectator.FeaturedGames.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.spectator.FeaturedGames transform(final FeaturedMatches item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.spectator.FeaturedGames games = new de.zahrie.trues.api.riot.xayah.types.dto.spectator.FeaturedGames();
    ...
    @Transform(from = GameCustomizationObject.class, to = de.zahrie.trues.api.riot.xayah.types.dto.spectator.GameCustomizationObject.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.spectator.GameCustomizationObject transform(final GameCustomizationObject item,
        final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.spectator.GameCustomizationObject object =
            new de.zahrie.trues.api.riot.xayah.types.dto.spectator.GameCustomizationObject();
        object.setCategory(item.getCategory());
        object.setContent(item.getContent());
        return object;
    }

    @Transform(from = Participant.class, to = de.zahrie.trues.api.riot.xayah.types.dto.spectator.Participant.class)
    public de.zahrie.trues.api.riot.xayah.types.dto.spectator.Participant transform(final Participant item, final PipelineContext context) {
        final de.zahrie.trues.api.riot.xayah.types.dto.spectator.Participant player = new de.zahrie.trues.api.riot.xayah.types.dto.spectator.Participant();
        player.setBot(item.isBot());
    ...
    public CurrentGameParticipant transform(final Player item, final PipelineContext context) {
        ...
        final List<de.zahrie.trues.api.riot.xayah.types.dto.spectator.GameCustomizationObject> objects = new ArrayList<>();
