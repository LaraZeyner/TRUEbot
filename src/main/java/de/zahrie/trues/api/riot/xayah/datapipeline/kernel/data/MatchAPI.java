  ...
  public CloseableIterator<Match> getManyMatch(final Map<String, Object> query, final PipelineContext context) {
    ...
    return CloseableIterators.from(new Iterator<>() {
      ...
      public Match next() {
        ...
        String endpoint = "lol/match/v4/matches/" + matchId;
        if (tournamentCode != null) {
          endpoint += "/by-tournament-code/" + tournamentCode;
        }
        return get(Match.class, endpoint, ImmutableMap.of("platform", platform.getTag()));
      }
  ...
  public CloseableIterator<Timeline> getManyTimeline(final Map<String, Object> query, final PipelineContext context) {
    ...
    return CloseableIterators.from(new Iterator<>() {
      ...
      public Timeline next() {
        ...
        return get(Timeline.class, endpoint, ImmutableMap.of("platform", platform.getTag()));
      }
