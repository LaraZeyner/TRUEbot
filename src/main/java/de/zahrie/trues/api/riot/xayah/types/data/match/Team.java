...
public class Team extends CoreData {
  ...
  private List<Integer> bans, pickTurns;
  ...
  /**
   * @return the pickTurns
   */
  public List<Integer> getPickTurns() {
    return pickTurns;
  }
  ...
  /**
   * @param baronKills the baronKills to set
   */
  ...
  /**
   * @param dominionScore the dominionScore to set
   */
  ...
  /**
   * @param dragonKills the dragonKills to set
   */
  ...
  /**
   * @param firstBaronKiller the firstBaronKiller to set
   */
  ...
  /**
   * @param firstBloodKiller the firstBloodKiller to set
   */
  ...
  /**
   * @param firstDragonKiller the firstDragonKiller to set
   */
  ...
  /**
   * @param firstInhibitorKiller the firstInhibitorKiller to set
   */
  ...
  /**
   * @param firstRiftHeraldKiller the firstRiftHeraldKiller to set
   */
  ...
  /**
   * @param firstTowerKiller the firstTowerKiller to set
   */
  ...
  /**
   * @param inhibitorKills the inhibitorKills to set
   */
  ...
  /**
   * @param pickTurns the pickTurns to set
   */
  public void setPickTurns(List<Integer> pickTurns) {
    this.pickTurns = pickTurns;
  }
  ...
  /**
   * @param riftHeraldKills the riftHeraldKills to set
   */
  ...
  /**
   * @param towerKills the towerKills to set
   */
  ...
  /**
   * @param vilemawKills the vilemawKills to set
   */
