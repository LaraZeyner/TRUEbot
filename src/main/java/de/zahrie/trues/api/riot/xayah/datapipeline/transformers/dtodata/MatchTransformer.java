...
import de.zahrie.trues.api.riot.xayah.types.data.match.Event;
import de.zahrie.trues.api.riot.xayah.types.data.match.Frame;
import de.zahrie.trues.api.riot.xayah.types.data.match.Match;
...
import de.zahrie.trues.api.riot.xayah.types.data.match.Participant;
import de.zahrie.trues.api.riot.xayah.types.data.match.ParticipantFrame;
import de.zahrie.trues.api.riot.xayah.types.data.match.ParticipantStats;
import de.zahrie.trues.api.riot.xayah.types.data.match.ParticipantTimeline;
import de.zahrie.trues.api.riot.xayah.types.data.match.Position;
import de.zahrie.trues.api.riot.xayah.types.data.match.RuneStats;
import de.zahrie.trues.api.riot.xayah.types.data.match.StatTotals;
import de.zahrie.trues.api.riot.xayah.types.data.match.Team;
import de.zahrie.trues.api.riot.xayah.types.data.match.Timeline;
import de.zahrie.trues.api.riot.xayah.types.data.match.TournamentMatches;
import de.zahrie.trues.api.riot.xayah.types.dto.match.MatchEvent;
import de.zahrie.trues.api.riot.xayah.types.dto.match.MatchFrame;
import de.zahrie.trues.api.riot.xayah.types.dto.match.MatchParticipantFrame;
import de.zahrie.trues.api.riot.xayah.types.dto.match.MatchPosition;
...
import de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantIdentity;
import de.zahrie.trues.api.riot.xayah.types.dto.match.TeamBans;
import de.zahrie.trues.api.riot.xayah.types.dto.match.TeamStats;
...
public class MatchTransformer extends AbstractDataTransformer {
  ...
  @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.match.Match.class, to = Match.class)
  public Match transform(final de.zahrie.trues.api.riot.xayah.types.dto.match.Match item, final PipelineContext context) {
    ...
    for (final TeamStats team : item.getTeams()) {
      if (de.zahrie.trues.api.riot.xayah.types.common.Side.BLUE.getId() == team.getTeamId()) {
    ...
    final Map<Integer, de.zahrie.trues.api.riot.xayah.types.dto.match.Participant> byId = new HashMap<>();
    for (final de.zahrie.trues.api.riot.xayah.types.dto.match.Participant participant : item.getParticipants()) {
    ...
    for (final ParticipantIdentity element : item.getParticipantIdentities()) {
      ...
      final de.zahrie.trues.api.riot.xayah.types.dto.match.Player player = element.getPlayer();
      final de.zahrie.trues.api.riot.xayah.types.dto.match.Participant participant = byId.get(participantId);
  ...
  @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.match.MatchReference.class, to = MatchReference.class)
  public MatchReference transform(final de.zahrie.trues.api.riot.xayah.types.dto.match.MatchReference item, final PipelineContext context) {
  ...
  @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.match.Participant.class, to = Participant.class)
  public Participant transform(final de.zahrie.trues.api.riot.xayah.types.dto.match.Participant item, final PipelineContext context) {
    ...
    final de.zahrie.trues.api.riot.xayah.types.dto.match.Player player = (de.zahrie.trues.api.riot.xayah.types.dto.match.Player) context.get("player");
    if (player != null) {
  ...
  @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantStats.class, to = ParticipantStats.class)
  public ParticipantStats transform(final de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantStats item, final PipelineContext context) {
  ...
  @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantTimeline.class, to = ParticipantTimeline.class)
  public ParticipantTimeline transform(final de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantTimeline item, final PipelineContext context) {
  ...
  @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.match.Player.class, to = Participant.class)
  public Participant transform(final de.zahrie.trues.api.riot.xayah.types.dto.match.Player item, final PipelineContext context) {
    ...
    final de.zahrie.trues.api.riot.xayah.types.dto.match.Participant participant =
        (de.zahrie.trues.api.riot.xayah.types.dto.match.Participant) context.get("participant");
  ...
  @Transform(from = de.zahrie.trues.api.riot.xayah.types.dto.match.TournamentMatches.class, to = TournamentMatches.class)
  public TournamentMatches transform(final de.zahrie.trues.api.riot.xayah.types.dto.match.TournamentMatches item, final PipelineContext context) {
  ...
  @Transform(from = Match.class, to = de.zahrie.trues.api.riot.xayah.types.dto.match.Match.class)
  public de.zahrie.trues.api.riot.xayah.types.dto.match.Match transform(final Match item, final PipelineContext context) {
    final Object previousDuration = context.put("duration", item.getDuration());
    final de.zahrie.trues.api.riot.xayah.types.dto.match.Match match = new de.zahrie.trues.api.riot.xayah.types.dto.match.Match();
    ...
    final List<de.zahrie.trues.api.riot.xayah.types.dto.match.Participant> participants = new ArrayList<>(item.getParticipants().size());
    final int id = 1;
  ...
  public MatchList transform(final Matchlist item, final PipelineContext context) {
    ...
    for (final de.zahrie.trues.api.riot.xayah.types.dto.match.MatchReference match : item.getMatches()) {
  ...
  public Matchlist transform(final MatchList item, final PipelineContext context) {
    ...
    final List<de.zahrie.trues.api.riot.xayah.types.dto.match.MatchReference> matches =
        item.stream().map(match -> transform(match, context)).collect(Collectors.toCollection(() -> new ArrayList<>(item.size())));
    list.setAccountId(item.getAccountId());
    list.setChampions(new HashSet<>(item.getChampions()));
    list.setEndIndex(item.getEndIndex());
  ...
  @Transform(from = MatchReference.class, to = de.zahrie.trues.api.riot.xayah.types.dto.match.MatchReference.class)
  public de.zahrie.trues.api.riot.xayah.types.dto.match.MatchReference transform(final MatchReference item, final PipelineContext context) {
    final de.zahrie.trues.api.riot.xayah.types.dto.match.MatchReference reference = new de.zahrie.trues.api.riot.xayah.types.dto.match.MatchReference();
    reference.setAccountId(item.getAccountId());
  ...
  @Transform(from = Participant.class, to = de.zahrie.trues.api.riot.xayah.types.dto.match.Player.class)
  public de.zahrie.trues.api.riot.xayah.types.dto.match.Player transform(final Participant item, final PipelineContext context) {
    final de.zahrie.trues.api.riot.xayah.types.dto.match.Player player = new de.zahrie.trues.api.riot.xayah.types.dto.match.Player();
    player.setAccountId(item.getAccountId());
    player.setCurrentAccountId(item.getCurrentAccountId());
  ...
  @Transform(from = ParticipantStats.class, to = de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantStats.class)
  public de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantStats transform(final ParticipantStats item, final PipelineContext context) {
    final de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantStats stats = new de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantStats();
    stats.setAltarsCaptured(item.getAltarsCaptured());
    stats.setAltarsNeutralized(item.getAltarsNeutralized());
    stats.setAssists(item.getAssists());
  ...
  @Transform(from = ParticipantTimeline.class, to = de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantTimeline.class)
  public de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantTimeline transform(final ParticipantTimeline item, final PipelineContext context) {
    final de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantTimeline timeline = new de.zahrie.trues.api.riot.xayah.types.dto.match.ParticipantTimeline();
  ...
  public TeamStats transform(final Team item, final PipelineContext context) {
    ...
    int turn = de.zahrie.trues.api.riot.xayah.types.common.Side.BLUE.getId() == item.getTeamId() ? 1 : isTenBanMode ? 6 : 2;
  ...
  public Team transform(final TeamStats item, final PipelineContext context) {
    ...
    final List<Integer> pickTurns = new ArrayList<>(item.getBans().size());
    for (final TeamBans ban : item.getBans()) {
      bans.add(ban.getChampionId());
      bans.add(ban.getPickTurn());
    }
    team.setTeamId(item.getTeamId());
    team.setBans(bans);
    team.setBaronKills(item.getBaronKills());
  ...
  @Transform(from = TournamentMatches.class, to = de.zahrie.trues.api.riot.xayah.types.dto.match.TournamentMatches.class)
  public de.zahrie.trues.api.riot.xayah.types.dto.match.TournamentMatches transform(final TournamentMatches item, final PipelineContext context) {
    final de.zahrie.trues.api.riot.xayah.types.dto.match.TournamentMatches matches =
        new de.zahrie.trues.api.riot.xayah.types.dto.match.TournamentMatches(item.size());
    matches.addAll(item);
    matches.setPlatform(item.getPlatform());
    matches.setTournamentCode(item.getTournamentCode());
    return matches;
  ...
  @Transform(from = Participant.class, to = de.zahrie.trues.api.riot.xayah.types.dto.match.Participant.class)
  public de.zahrie.trues.api.riot.xayah.types.dto.match.Participant transformToParticipant(final Participant item, final PipelineContext context) {
