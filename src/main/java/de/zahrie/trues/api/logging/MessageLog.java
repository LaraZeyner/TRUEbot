...
public class MessageLog extends AbstractServerLog implements Entity<MessageLog> {
  ...
  public MessageLog(@NotNull LocalDateTime timestamp, @NotNull String details, @Nullable DiscordUser invoker, @Nullable DiscordUser target,
                    @NotNull AbstractDiscordChannel channel, @NotNull MessageDeleteReason reason) {
