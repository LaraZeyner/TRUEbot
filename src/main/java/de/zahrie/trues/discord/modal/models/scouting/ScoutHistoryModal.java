...
public class ScoutHistoryModal extends ModalImpl {
  ...
  public Modal getModal(boolean value) {
    return create("Scouting: Team-Matchhistory")
        ...
        .optional("3", "Tage:", "Scoutingdauer in Tagen", 3)
        .optional("4", "Seite:", "Seite", 3).get();
  }
  ...
  public boolean execute(ModalInteractionEvent event) {
    ...
    final Integer page = getInt("4", 1);
    ScoutingManager.custom(team2, event, ScoutingType.HISTORY, gameType, duration, page);
    return true;
  }
}
