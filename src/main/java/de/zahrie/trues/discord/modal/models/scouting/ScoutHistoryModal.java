...
public class ScoutHistoryModal extends ModalImpl {
  ...
  public Modal getModal(boolean value) {
    return create("Scouting: Team-Matchhistory")
        ...
        .single("3", "Tage:", "Scoutingdauer in Tagen", 3)
        .single("4", "Seite:", "Seite", 3).get();
  }
  ...
  public boolean execute(ModalInteractionEvent event) {
    ...
    final Integer page = getInt("4");
    ScoutingManager.custom(team2, event, Scouting.ScoutingType.HISTORY, gameType, duration == null ? 180 : duration, page == null ? 1 : page);
    return true;
  }
}
