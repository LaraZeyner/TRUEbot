...
@View(value = ModalRegisterer.SCOUT_OVERVIEW)
@ExtensionMethod(DiscordUserFactory.class)
public class ScoutOverviewModal extends ModalImpl {
  @Override
  public Modal getModal(boolean value) {
    return create("Scouting: Team-Übersicht")
  ...
  public boolean execute(ModalInteractionEvent event) {
    ScoutingManager.custom(getTeamIdOrName(), event, Scouting.ScoutingType.OVERVIEW, getScoutingGameType(), getDuration());
    return true;
  }
}
