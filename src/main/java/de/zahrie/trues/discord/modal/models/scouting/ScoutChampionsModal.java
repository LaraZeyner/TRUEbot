...
@View(value = ModalRegisterer.SCOUT_CHAMPIONS)
@ExtensionMethod(DiscordUserFactory.class)
public class ScoutChampionsModal extends ModalImpl {
  @Override
  public Modal getModal(boolean value) {
    return create("Scouting: Team-Champions")
  ...
  public boolean execute(ModalInteractionEvent event) {
    ScoutingManager.custom(getTeamIdOrName(), event, Scouting.ScoutingType.CHAMPIONS, getScoutingGameType(), getDuration());
    return true;
  }
}
