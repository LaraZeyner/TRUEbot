...
@Command(name = "bewerbungen", descripion = "Liste aller offenen Bewerbungen", perm = @Perm(PermissionRole.ORGA_MEMBER))
public class BewerbungenCommand extends SlashCommand {
  @Override
