package de.zahrie.trues.truebot.util.logger;

import de.zahrie.trues.truebot.util.logger.jcolor.AnsiFormat;
import de.zahrie.trues.truebot.util.logger.jcolor.Attribute;
import static de.zahrie.trues.truebot.util.logger.jcolor.Attribute.BOLD;
import static de.zahrie.trues.truebot.util.logger.jcolor.Attribute.DIM;
