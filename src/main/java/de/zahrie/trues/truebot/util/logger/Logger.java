...
public class Logger {
  ...
  public Logger(String name) {
    ...
    final StackWalker.StackFrame frame = walker.walk(stackFrameStream -> stackFrameStream.skip(2).findFirst().orElse(null));
    this.method = frame.getClassName() + "." + frame.getMethodName();
  }
