package de.zahrie.trues.truebot.dc.command;

import java.util.Objects;

import de.zahrie.trues.truebot.dc.util.cmd.SlashCommand;
...
public class TestCommand extends SlashCommand {
  ...
  @Override
  @Msg(value = "Hi **{}**", embeds = {
      @Embed(description = "Team-Standings", queries = @DBQuery(query = "Team.Teaminfo", columns = {@Column("Teamname"), @Column("Division"), @Column("Score")}))})
