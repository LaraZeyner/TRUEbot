package de.zahrie.trues.truebot.dc.util.cmd;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import de.zahrie.trues.truebot.dc.builder.EmbedWrapper;
import de.zahrie.trues.truebot.dc.builder.InfoPanelBuilder;
import de.zahrie.trues.truebot.dc.util.cmd.annotations.Command;
import de.zahrie.trues.truebot.dc.util.cmd.annotations.Embed;
import de.zahrie.trues.truebot.dc.util.cmd.annotations.Msg;
import de.zahrie.trues.truebot.dc.util.cmd.annotations.Option;
import de.zahrie.trues.truebot.util.Const;
import de.zahrie.trues.truebot.util.Time;
