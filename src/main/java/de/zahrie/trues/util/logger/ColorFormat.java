...
import de.zahrie.trues.util.logger.jcolor.AnsiFormat;
import de.zahrie.trues.util.logger.jcolor.Attribute;
import static de.zahrie.trues.util.logger.jcolor.Attribute.BOLD;
import static de.zahrie.trues.util.logger.jcolor.Attribute.DIM;
